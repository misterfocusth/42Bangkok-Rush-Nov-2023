...
silePortButton.addEventListener("click", () =>
  showPortfolioPageById("sipakdee")
);
silaProfileCard.addEventListener("click", () =>
  showPortfolioPageById("sipakdee")
);
surutaPortButton.addEventListener("click", () =>
  showPortfolioPageById("storaat")
);
sarutaProfileCard.addEventListener("click", () =>
  showPortfolioPageById("storaat")
);
